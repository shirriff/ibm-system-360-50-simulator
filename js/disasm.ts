...
0x28: ['LDR', 'Load'],
0x29: ['CDR', 'Compare'],
0x2a: ['ADR', 'Add Normalized'],
0x2b: ['SDR', 'Subtract Normalized'],
0x2c: ['MDR', 'Multiply'],
0x2d: ['DDR', 'Divide'],
0x2e: ['AWR', 'Add Unnormalized'],
0x2f: ['SWR', 'Subtract Unnormalized'],
...
0x38: ['LER', 'Load'],
0x39: ['CER', 'Compare'],
0x3a: ['AER', 'Add Normalized'],
0x3b: ['SER', 'Subtract Normalized'],
0x3c: ['MER', 'Multiply'],
0x3d: ['DER', 'Divide'],
0x3e: ['AUR', 'Add Unnormalized'],
0x3f: ['SUR', 'Subtract Unnormalized'],
...
0x4b: ['SH', 'Subtract'],
0x4c: ['MH', 'Multiply'],
0x4e: ['CVD', 'Convert to Decimal'],
0x4f: ['CVB', 'Convert to Binary'],
...
0x69: ['CD', 'Compare'],
0x6a: ['AD', 'AddN'],
0x6b: ['SD', 'Subtract Normalized'],
0x6c: ['MD', 'Multiply'],
0x6d: ['DD', 'Divide'],
0x6e: ['AW', 'Add Unnormalized'],
0x6f: ['SW', 'Subtract Unnormalized'],

0x70: ['STE', 'Store'],
0x78: ['LE', 'Load'],
0x79: ['CE', 'Compare'],
0x7a: ['AE', 'Add Normalized'],
0x7b: ['SE', 'Subtract Normalized'],
0x7c: ['ME', 'Multiply'],
0x7d: ['DE', 'Divide'],
0x7e: ['AU', 'Add Unnormalized'],
0x7f: ['SU', 'Subtract Unnormalized'],
...
0x88: ['SRL', 'Shift Right Single Logical'],
0x89: ['SLL', 'Shift Left Single Logical'],
0x8a: ['SRA', 'Shift Right Single'],
0x8b: ['SLA', 'Shift Left Single'],
0x8c: ['SRDL', 'Shift Right Double Logical'],
0x8d: ['SLDL', 'Shift Left Double Logical'],
0x8e: ['SRDA', 'Shift Right Double'],
0x8f: ['SLDA', 'Shift Left Double'],
